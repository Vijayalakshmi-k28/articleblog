...
<?php 
    ...
    <?php
        try {
            ...
            $stmt = $db->query('SELECT articleId, articleTitle, articleDate FROM article ORDER BY articleId DESCRIPTION');
            while($row = $stmt->fetch()){
                ...
                <td>
                     <button class="editbtn" > <a href="edit-articleblog.php?id=<?php echo $row['articleId'];?>" >Edit </a >  </button ></td> <td>
    ...
    <p> <button class="editbtn"><a href='add-articleblog.php'>Add New Article</a></button></p>       
</p></div>
